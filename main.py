...
import FrpAmplMipSolver as famp
...
frp_inst = frp.FastRouteProb(dist_matrix=dist_matrix)
frp_solver = famp.FrpAmplMipSolver()
...
dist_matrix = [[   0, 107, 241, 190, 124,  80, 316,  76, 152, 157, 283, 133, 113, 297, 228, 129, 348, 276, 188, 150,  65, 341, 184,  67, 221, 169, 108,  45, 167],
